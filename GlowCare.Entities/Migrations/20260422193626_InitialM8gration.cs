...
{
    /// <inheritdoc />
    public partial class InitialM8gration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("29965aaa-46cf-4829-93b8-e38401be7547"), 0, 38, "7ceacac6-fa4d-4db9-ad6b-d28033f4c114", "maria.petrova@gmail.com", true, "Мария", 1, false, true, "Петрова", false, null, 0, null, "MARIA.PETROVA@GMAIL.COM", "MARIA.PETROVA", "AQAAAAIAAYagAAAAEHtASgpdhVbCPi/j0Ik5a1C7NSxcXqLAl3Wbtt/DA1vN+J7lUv162Kv4BPYSIyV/gw==", "0899123456", true, "68e7add5-6f2f-4792-a2e6-01f596c74a52", false, "maria.petrova" },
                    { new Guid("a7d3c5e2-9b41-4f12-8f34-123456789abc"), 0, 32, "07d25f01-496f-4338-a289-80d20a55ff46", "elena.dimitrova@gmail.com", true, "Елена", 1, false, true, "Димитрова", false, null, 0, null, "ELENA.DIMITROVA@GMAIL.COM", "ELENA.DIMITROVA", "AQAAAAIAAYagAAAAEAwB9Urfs/3/yau1Id5TvThbqZQHOjE6Crdc/3aJUYW1zGfI8f+yaQASRPpwQgHy5w==", "0888123456", true, "bfb94cc6-d1c4-4315-8f5e-f1d3535f4c01", false, "elena.dimitrova" },
                    { new Guid("ac31b0bb-d05a-438d-be06-9bfe3323cf08"), 0, 30, "8f657107-c426-45ba-95b1-9d50d864e0ab", "johndoe@gmail.com", true, "Джон", 0, false, true, "Доу", false, null, 0, null, "JOHNDOE@GMAIL.COM", "JOHN.DOE", "AQAAAAIAAYagAAAAEHRk2lkJyn7P8OkZzh8zpgcHFnx4YmHJLcZFgAJ22/UxO4GldMfjC1PN+vyrvsPCbQ==", "0875757574", true, "a6241046-575b-4a3f-a668-c6aa755a232f", false, "john.doe" },
                    { new Guid("c9f4e7b1-2d33-4a11-8f56-abcdef123456"), 0, 30, "b5efc2d7-5be7-4fc5-b8a6-f1f935fdacf6", "ivana.koleva@gmail.com", true, "Ивана", 1, false, true, "Колева", false, null, 0, null, "IVANA.KOLEVA@GMAIL.COM", "IVANA.KOLEVA", "AQAAAAIAAYagAAAAEPgxfSzNx9r6tRQlx8puCDiRpdh1JB+gjQXbI1BCcSf2Avuu+nVdEy8wg12I2i0lcw==", "0888234567", true, "e0ff1671-f59e-407c-a1bc-b6034b44ac41", false, "ivana.koleva" },
                    { new Guid("fc95b3fa-f342-4172-ac8b-5b35951ad760"), 0, 18, "fe2a9ea6-fde8-4113-a3fb-814f3b9174a2", "teodora_nedkova@abv.bg", true, "Теодора", 1, false, false, "Недкова", false, null, 0, null, "TEODORA_NEDKOVA@ABV.BG", "TEODORA.NEDKOVA", "AQAAAAIAAYagAAAAENBNeMEjSBv+XaO23n5PqLCx2DF0sbqo+EnXbC+2P2AopNubu5Oz0PMpsd2z3jxeIw==", "0878654562", true, "258513a82f1147ba92a0e43f1602b7c3", false, "teodora.nedkova" }
                });
            ...
            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "Age", "ConcurrencyStamp", "Email", "EmailConfirmed", "FirstName", "Gender", "IsDeleted", "IsSpecialist", "LastName", "LockoutEnabled", "LockoutEnd", "LoyaltyPoints", "MembershipId", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { new Guid("e5c2a9b3-4a67-4f89-8d23-556677889900"), 0, 30, "90243b04-1bad-480a-a2de-cf7657d834cc", "nikol.georgieva@gmail.com", true, "Никол", 1, false, false, "Георгиева", false, null, 0, 1, "NIKOL.GEORGIEVA@GMAIL.COM", "NIKOL.GEORGIEVA", "AQAAAAIAAYagAAAAEB/fGKTHK1tFb2GdHT3m/+acY9RceL8aGHhACaRP6qN1WDJuDTrii/8hpNGCmH3LKA==", "0855123456", true, "e9c2550f-30cc-4116-a85c-20265258d5a5", false, "nikol.georgieva" });
            ...
            migrationBuilder.InsertData(
                table: "Procedures",
                columns: new[] { "Id", "AppointmentDate", "CancelledBy", "EmployeeId", "IsDeleted", "Notes", "RewardPointsGranted", "ServiceId", "Status", "UserId" },
                values: new object[,]
                {
                    { 1, new DateTime(2025, 9, 28, 10, 30, 0, 0, DateTimeKind.Unspecified), null, new Guid("66e6b9a6-4c5a-4344-bdae-6edbacc4b608"), false, "Първоначална консултация, заявен е задълбочен анализ на кожата.", false, 5, 1, new Guid("e5c2a9b3-4a67-4f89-8d23-556677889900") },
                    { 2, new DateTime(2025, 9, 29, 14, 0, 0, 0, DateTimeKind.Unspecified), null, new Guid("b75e8e37-95e4-44ef-a32c-10aebaff55b3"), false, "Последваща сесия за масажна терапия.", false, 6, 2, new Guid("fc95b3fa-f342-4172-ac8b-5b35951ad760") },
                    { 3, new DateTime(2025, 10, 1, 9, 0, 0, 0, DateTimeKind.Unspecified), null, new Guid("1dccdb69-fbd1-43c4-8c17-95796b5aa95e"), false, "Планирана е процедура за подмладяване на лицето.", false, 8, 0, new Guid("fc95b3fa-f342-4172-ac8b-5b35951ad760") }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Отлично обслужване! Процедурата беше извършена професионално и се чувствах много комфортно.", new DateTime(2026, 4, 22, 19, 36, 25, 742, DateTimeKind.Utc).AddTicks(9032), new Guid("66e6b9a6-4c5a-4344-bdae-6edbacc4b608"), false, 1, 5, 5, new Guid("fc95b3fa-f342-4172-ac8b-5b35951ad760") });
