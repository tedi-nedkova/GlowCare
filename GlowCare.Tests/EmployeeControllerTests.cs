...
public class EmployeeControllerTests
{
    ...
    public async Task Index_ShouldReturnViewWithEmployees()
    {
        ...
        var controller = ControllerTestHelpers.AttachHttpContext(new EmployeeController(employeeService.Object, new Mock<ISpecialistApplicationService>().Object, Mock.Of<ILogger<EmployeeController>>()));
    ...
    {
        var controller = ControllerTestHelpers.AttachHttpContext(new EmployeeController(new Mock<IEmployeeService>().Object, new Mock<ISpecialistApplicationService>().Object, Mock.Of<ILogger<EmployeeController>>()));
    ...
    public async Task Apply_Get_ShouldHideForm_WhenPendingApplicationExists()
    {
        ...
        var controller = ControllerTestHelpers.AttachHttpContext(new EmployeeController(new Mock<IEmployeeService>().Object, appService.Object, Mock.Of<ILogger<EmployeeController>>()), userId);
    ...
    {
        var controller = ControllerTestHelpers.AttachHttpContext(new EmployeeController(new Mock<IEmployeeService>().Object, new Mock<ISpecialistApplicationService>().Object, Mock.Of<ILogger<EmployeeController>>()), Guid.NewGuid());
